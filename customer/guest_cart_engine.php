...
<html>
  <head>
    ...
    <title>Гость XStore | digital</title>
                          ...
                          <td><?php echo $product_title; ?><br>
                           ...
                           <td>
                              <form class="" action="cart.php" method="post">
                                  ...
                                  <input  type="text" size="1" id="pqty"name="change_qty" value="<?php echo $prod_qty; ?>" style="margin-top: 2em; position: relative"/>
                                  <!--<input type="submit" name="update_product_now" value="Обновить" id="refresh"> -->
                                  <input type="submit" id="name-submit" value="Grab">

                              </form>
                              <?php
                              $_SESSION['id'] = '';
                                  if (isset($_POST['update_product_now'])) {
