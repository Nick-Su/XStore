...
<form action="" method="post" enctype="multipart/form-data">
    <table align="center" width="750">
          <tr align="center">
              <td colspan="6"><h2>Оновление профиля</h2></td>
          </tr>
                <tr>
                          ...
                          <tr>
                              <td align="right">Ваш текущий пароль</td>
                          ...
                          <tr>
                              ...
                              <tr>
                                  <td align="right">Ваш адрес</td>
                                  <td><input type="text" name="c_address" value="<?php echo $address ;  ?>"/></td>
                              </tr>
                          </tr>

                          <tr align="center">
                              <td colspan="6"><input type="submit" name="update" value="Обновить профиль!" /></td>
                          </tr>
...
<?php
  ...
  if(isset($_POST['update'])){
    ...
    $run_update = mysqli_query($con, $update_c) or die;;
